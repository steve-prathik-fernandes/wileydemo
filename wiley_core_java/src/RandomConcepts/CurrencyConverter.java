...
public class CurrencyConverter {
	...
	public static void Dihram_to_other(double amt) {
		System.out.println("1 Dihram = " + 22.27 + " Rupee");
		System.out.println();
		System.out.println(amt + " Dihram = " + (amt * 22.27) + " Rupee");
		System.out.println();

		System.out.println("1 Dihram = " +0.27  + " Dollar");
		System.out.println();
